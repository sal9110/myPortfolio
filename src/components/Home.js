    ...
    <div className='h-screen flex flex-col space-y-4 overflow-y-auto '>
      ...
      >
        <div className='flex flex-col md:flex-row justify-center items-center w-full md:w-auto pt-10 md:pt-5 '>
          <h1 className='w-full md:w-2/3 font-mochiy text-3xl md:text-5xl lg:text-6xl text-shadow  px-3 py-6 text-center'>
            {" "}
            Hi, I'm{" "}
            <span className='dark:text-orange text-orange-dark '>
              Salvo
            </span>{" "}
            <span className='text-4xl'>👋🏻 </span>
          </h1>
          <img
            className=' rounded-full filter border-4 dark:border-orange border-orange-dark  w-1/3 md:w-1/4'
            alt='me'
      ...
      >
        ...
        <div className='w-full flex justify-center'>
          <a
            className='flex px-4 py-2 my-4 w-full md:w-1/2 lg:w-1/3 xl:w-1/4 dark:bg-orange bg-orange-dark rounded text-2xl md:text-3xl lg:text-4xl justify-center  '
            target='_blank'
            rel='noreferrer'
