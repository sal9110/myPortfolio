...
const Home = () => {
  ...
  return (
    <div className='h-full flex flex-col space-y-6'>
      ...
      >
        <div className='flex flex-col md:flex-row justify-center items-center pt-1 md:pt-8 px-6 lg:pt-14  w-full'>
      ...
      >
        <div className=' flex justify-center items-center w-full px-6 '>
          <div className='md:w-5/6 py-3 md:p-10'>
            <h1 className='text-3xl md:text-4xl lg:text-5xl uppercase text-orange font-semibold'>
              About me
            </h1>
      ...
      <Transition
        show={isShowingText}
        className='h-1/6 md:h-2/6'
        enter='transition ease-linear duration-1000 transform '
        enterFrom='translate-y-full '
        enterTo='translate-y-0'>
        <div className=' flex justify-center items-center w-full h-5/6 py-4 px-6 '>
          <div className='flex flex-col justify-center items-center text-3xl md:text-4xl lg:text-5xl uppercase text-orange font-semibold'>
            ...
            <div className='flex justify-center flex-wrap  xl:w-full '>
              <span className='flex justify-center items-center  flex-wrap  w-full lg:w-5/6 space-x-3 md:space-x-5'>
                {profile.TechStack.map((el) =>
                  techIcons.hasOwnProperty(el) ? (
                    <i className='h-16 w-16 md:w-24 md:h-24 lg:h-30 lg:w-30 xl:w-36 w xl:h-36 p-3 xl:m-4'>
                      {" "}
                      {techIcons[el]()}{" "}
                    </i>
                  ) : null
